...
public final class TaskCalendarFactory {
    ...
    private static void configureDateField(final DateField df) {
     ...
     */
    public static CalendarPanel createCalendarPanel(final int quantity, final int orientation) {
        final CalendarPanel retorno = new CalendarPanel(quantity, orientation);
        configureCalendarPanel(retorno);
        return retorno;
    }
     ...
     * @return a new CalendarPanel
     */
    public static CalendarPanel createCalendarPanel(final int quantity) {
        final CalendarPanel retorno = new CalendarPanel(quantity, CalendarPanel.VERTICAL);
        configureCalendarPanel(retorno);
        return retorno;
    }

    private static void configureCalendarPanel(final CalendarPanel cp) {
     ...
     * @return a new DatePanel
     */
    public static DatePanel createDatePanel(final boolean showWeekNumbers) {
        final DatePanel retorno = new DatePanel(showWeekNumbers);
        configureDatePanel(retorno);
        return retorno;
    }

    private static void configureDatePanel(final DatePanel dp) {
