...
public final class JTableCustomizer {
     ...
     */
    public static void setDefaultEditor(final JTable table) {
     ...
     */
    public static void setDefaultEditor(final JTable table, final DateFormat format) {
     ...
     */
    public static void setEditorForRow(final JTable table, final int row) {
        final DateFormat format = DateFormat.getDateInstance(DateFormat.SHORT);
     ...
     * @param format Format to use
     */
    public static void setEditorForRow(final JTable table, final int row, final DateFormat format) {
