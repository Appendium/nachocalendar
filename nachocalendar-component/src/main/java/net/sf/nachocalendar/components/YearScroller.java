...
public class YearScroller extends javax.swing.JPanel {
    ...
    public YearScroller() {
        ...
        tYear.setValue(Integer.valueOf(cal.get(Calendar.YEAR)));
        final Border border = tYear.getBorder();
    ...
    private void tYearActionPerformed(final java.awt.event.ActionEvent evt) {
    ...
    public void setYear(final int year) {
        if ((year > 0) && (year < 2100)) {
            tYear.setValue(Integer.valueOf(year));
        }
    }
