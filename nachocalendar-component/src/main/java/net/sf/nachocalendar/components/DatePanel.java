...
public class DatePanel extends JPanel {
    ...
    public void dispose() {
        if (monthpanel != null) {
            ...
            for (int i = 0; i < daypanels.length; i++) {
                daypanels[i].removeMouseListener(mlistener);
                daypanels[i].removeKeyListener(klistener);
            }
            monthpanel.dispose();
            monthpanel = null;
        }
        ...
        calendar = null;
        navigation = null;
        if (monthscroller != null) {
            monthscroller.dispose();
            monthscroller = null;
        }
        if (yearscroller != null) {
            yearscroller.dispose();
            yearscroller = null;
        }
        dateSelectionModel = null;
        today = null;
        removeAll();
    }
     ...
     */
    public DatePanel(final boolean showWeekNumbers) {
    ...
    private void init() {
        ...
        final JPanel arriba = new JPanel(new GridLayout(1, 2));
    ...
    private void addListeners() {
        ...
        addMouseWheelListener(new MouseWheelListener() {
            public void mouseWheelMoved(final MouseWheelEvent e) {
                ...
                final int q = e.getWheelRotation();
        ...
        klistener = new KeyListener() {
            public void keyPressed(final KeyEvent e) {
                ...
                if ((keycode == KeyEvent.VK_LEFT) || (keycode == 226)) {
                    final int month = navigation.get(Calendar.MONTH);
    ...
    public void setFirstDayOfWeek(final int firstDayOfWeek) {
        if ((firstDayOfWeek == Calendar.MONDAY) || (firstDayOfWeek == Calendar.SUNDAY)) {
            ...
            final int old = monthpanel.getFirstDayOfWeek();
    ...
    public boolean[] getWorkingDays() {
        final boolean[] retorno = new boolean[workingDays.length];
    ...
    public void setWorkingDays(final boolean[] workingDays) {
        ...
        final boolean[] old = monthpanel.getWorkingdays();
    ...
    public void setSelectionMode(final int mode) {
        final int old = dateSelectionModel.getSelectionMode();
     ...
     *            The listener to register.
     */
    public synchronized void addActionListener(final java.awt.event.ActionListener listener) {
     ...
     *            The listener to remove.
     */
    public synchronized void removeActionListener(final java.awt.event.ActionListener listener) {
        if (actionListenerList != null) {
     ...
     *            The event to be fired
     */
    private void fireActionListenerActionPerformed(final java.awt.event.ActionEvent event) {
        java.util.ArrayList list;
        synchronized (this) {
            if (actionListenerList == null) {
                return;
     ...
     *            The listener to register.
     */
    public synchronized void addMonthChangeListener(final net.sf.nachocalendar.event.MonthChangeListener listener) {
        if (listenerList == null) {
            listenerList = new javax.swing.event.EventListenerList();
        }
     ...
     *            The listener to remove.
     */
    public synchronized void removeMonthChangeListener(final net.sf.nachocalendar.event.MonthChangeListener listener) {
     ...
     *            The event to be fired
     */
    private void fireMonthChangeListenerMonthIncreased(final net.sf.nachocalendar.event.MonthChangeEvent event) {
        if (listenerList == null) {
            return;
        }
        final Object[] listeners = listenerList.getListenerList();
     ...
     *            The event to be fired
     */
    private void fireMonthChangeListenerMonthDecreased(final net.sf.nachocalendar.event.MonthChangeEvent event) {
        if (listenerList == null) {
            return;
        }
        final Object[] listeners = listenerList.getListenerList();
     ...
     */
    public void setDateSelectionModel(final DateSelectionModel dateSelectionModel) {
