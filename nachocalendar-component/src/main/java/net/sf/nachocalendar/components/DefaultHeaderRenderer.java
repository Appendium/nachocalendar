...
public class DefaultHeaderRenderer extends JLabel implements HeaderRenderer {
    ...
    public DefaultHeaderRenderer() {
        ...
        final Font n = new Font(f.getName(), Font.BOLD | Font.ITALIC, f.getSize());
        setFont(n);
     ...
     */
    public Component getHeaderRenderer(final HeaderPanel panel, final Object value, final boolean isHeader, final boolean isWorking) {
