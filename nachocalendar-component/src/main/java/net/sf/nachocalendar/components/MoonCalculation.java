...
public class MoonCalculation {
     ...
     * fullMoon = 13 => day-1!
     */
    private final int fullMoon = 14; //day which should be full-moon
    private final int firstQuaterMoon = 7;
    private final int thirdQuaterMoon = 22;
    ...
    private static final String moon_phase_name[] = { "New", "Waxing crescent", "First quarter", "Waxing gibbous", "Full", "Waning gibbous", "Third quarter",
            "Waning crescent" };
    ...
    public int moonPhase(final int year, int month, final int day) {
    ...
    public boolean isLeapYearP(final int year) {
    ...
    String phaseName(final int phase) {
        return moon_phase_name[phase];
    }

    public Graphics drawMoon(final Graphics g, final Date d, final int posX, final int posY, final int size) {
        calendar.setTime(d);

        final int newPhase = moonPhase(calendar.get(Calendar.YEAR), calendar.get(Calendar.MONTH) + 1, calendar.get(Calendar.DATE));
